...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(SC_MEMBER_0);
	export_constant(SC_MEMBER_1);
	export_constant(SC_MEMBER_2);
	export_constant(SC_MEMBER_3);
	export_constant(SC_MEMBER_4);
	export_constant(SC_MEMBER_5);
	export_constant(SC_MEMBER_6);
	export_constant(SC_MEMBER_7);
	export_constant(SC_MEMBER_8);
	export_constant(SC_MEMBER_9);
	export_constant(SC_MEMBER_10);
	export_constant(SC_VIP_SYSTEM);
	export_constant(SC_THE_BOX_DEBUFF);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	export_constant(EFST_VIP_SYSTEM); // VIP System
	export_constant(EFST_THE_BOX_DEBUFF);
	export_constant(EFST_MEMBER_0);
	export_constant(EFST_MEMBER_1);
	export_constant(EFST_MEMBER_2);
	export_constant(EFST_MEMBER_3);
	export_constant(EFST_MEMBER_4);
	export_constant(EFST_MEMBER_5);
	export_constant(EFST_MEMBER_6);
	export_constant(EFST_MEMBER_7);
	export_constant(EFST_MEMBER_8);
	export_constant(EFST_MEMBER_9);
	export_constant(EFST_MEMBER_10);
	...
	export_constant(UMOB_DYNAMIC_DAMAGE); // [Start]
	...
	export_constant(IG_EGG_EGG_ITEM0);
	export_constant(IG_EGG_EGG_ITEM1);
	export_constant(IG_EGG_EGG_ITEM2);
	export_constant(IG_EGG_EGG_ITEM3);
	export_constant(IG_EGG_EGG_ITEM4);
	export_constant(IG_EGG_EGG_ITEM5);
	export_constant(IG_EGG_EGG_ITEM6);
	export_constant(IG_EGG_EGG_ITEM7);
	export_constant(IG_EGG_EGG_ITEM8);
	export_constant(IG_EGG_EGG_ITEM9);
	export_constant(IG_EGG_EGG_ITEM10);
	export_constant(IG_EGG_EGG_ITEM11);
	export_constant(IG_EGG_EGG_ITEM12);
	export_constant(IG_EGG_EGG_ITEM13);
	export_constant(IG_EGG_EGG_ITEM14);
	export_constant(IG_EGG_EGG_ITEM15);
	export_constant(IG_EGG_EGG_ITEM16);
	export_constant(IG_EGG_EGG_ITEM17);
	export_constant(IG_EGG_EGG_ITEM18);
	export_constant(IG_EGG_EGG_ITEM19);
	export_constant(IG_EGG_EGG_ITEM20);
	export_constant(IG_EGG_EGG_ITEM21);
	export_constant(IG_EGG_EGG_ITEM22);
	export_constant(IG_EGG_EGG_ITEM23);
	export_constant(IG_EGG_EGG_ITEM24);
	export_constant(IG_EGG_EGG_ITEM25);
	export_constant(IG_EGG_EGG_ITEM26);
	export_constant(IG_EGG_EGG_ITEM27);
	export_constant(IG_EGG_EGG_ITEM28);
	export_constant(IG_EGG_EGG_ITEM29);
	export_constant(IG_EGG_EGG_ITEM30);
	export_constant(IG_EGG_EGG_ITEM31);
	export_constant(IG_EGG_EGG_ITEM32);
	export_constant(IG_EGG_EGG_ITEM33);
	export_constant(IG_EGG_EGG_ITEM34);
	export_constant(IG_EGG_EGG_ITEM35);
	export_constant(IG_EGG_EGG_ITEM36);
	export_constant(IG_EGG_EGG_ITEM37);
	export_constant(IG_EGG_EGG_ITEM38);
	export_constant(IG_EGG_EGG_ITEM39);
	export_constant(IG_EGG_EGG_ITEM40);
	export_constant(IG_EGG_EGG_ITEM41);
	export_constant(IG_EGG_EGG_ITEM42);
	export_constant(IG_EGG_EGG_ITEM43);
	export_constant(IG_EGG_EGG_ITEM44);
	export_constant(IG_EGG_EGG_ITEM45);
	export_constant(IG_EGG_EGG_ITEM46);
	export_constant(IG_EGG_EGG_ITEM47);
	export_constant(IG_EGG_EGG_ITEM48);
	export_constant(IG_EGG_EGG_ITEM49);
	export_constant(IG_EGG_EGG_ITEM50);
	export_constant(IG_EGG_EGG_ITEM51);
	export_constant(IG_EGG_EGG_ITEM52);
	export_constant(IG_EGG_EGG_ITEM53);
	export_constant(IG_EGG_EGG_ITEM54);
	export_constant(IG_EGG_EGG_ITEM55);
	export_constant(IG_EGG_EGG_ITEM56);
	export_constant(IG_EGG_EGG_ITEM57);
	export_constant(IG_EGG_EGG_ITEM58);
	export_constant(IG_EGG_EGG_ITEM59);
	export_constant(IG_EGG_EGG_ITEM60);
	export_constant(IG_EGG_EGG_ITEM61);
	export_constant(IG_EGG_EGG_ITEM62);
	export_constant(IG_EGG_EGG_ITEM63);
	export_constant(IG_EGG_EGG_ITEM64);
	export_constant(IG_EGG_EGG_ITEM65);
	export_constant(IG_EGG_EGG_ITEM66);
	export_constant(IG_EGG_EGG_ITEM67);
	export_constant(IG_EGG_EGG_ITEM68);
	export_constant(IG_EGG_EGG_ITEM69);
	export_constant(IG_EGG_EGG_ITEM70);
	export_constant(IG_EGG_EGG_ITEM71);
	export_constant(IG_EGG_EGG_ITEM72);
	export_constant(IG_EGG_EGG_ITEM73);
	export_constant(IG_EGG_EGG_ITEM74);
	export_constant(IG_EGG_EGG_ITEM75);
	export_constant(IG_EGG_EGG_ITEM76);
	export_constant(IG_EGG_EGG_ITEM77);
	export_constant(IG_EGG_EGG_ITEM78);
	export_constant(IG_EGG_EGG_ITEM79);
	export_constant(IG_EGG_EGG_ITEM80);
	export_constant(IG_EGG_EGG_ITEM81);
	export_constant(IG_EGG_EGG_ITEM82);
	export_constant(IG_EGG_EGG_ITEM83);
	export_constant(IG_EGG_EGG_ITEM84);
	export_constant(IG_EGG_EGG_ITEM85);
	export_constant(IG_EGG_EGG_ITEM86);
	export_constant(IG_EGG_EGG_ITEM87);
	export_constant(IG_EGG_EGG_ITEM88);
	export_constant(IG_EGG_EGG_ITEM89);
	export_constant(IG_EGG_EGG_ITEM90);
	export_constant(IG_EGG_EGG_ITEM91);
	export_constant(IG_EGG_EGG_ITEM92);
	export_constant(IG_EGG_EGG_ITEM93);
	export_constant(IG_EGG_EGG_ITEM94);
	export_constant(IG_EGG_EGG_ITEM95);
	export_constant(IG_EGG_EGG_ITEM96);
	export_constant(IG_EGG_EGG_ITEM97);
	export_constant(IG_EGG_EGG_ITEM98);
	export_constant(IG_EGG_EGG_ITEM99);
	export_constant(IG_EGG_EGG_ITEM100);
	...
	/* Custom Hateffects */
	export_constant(HAT_EF_enchanting_shadow_B);
	export_constant(HAT_EF_abyss_strike_A);
	export_constant(HAT_EF_abyss_strike_B);
	export_constant(HAT_EF_mystery_illusion_A);
	export_constant(HAT_EF_mystery_illusion_B);
	export_constant(HAT_EF_deadly_projection_A);
	export_constant(HAT_EF_deadly_projection_B);
	export_constant(HAT_EF_astralstrike_A);
	export_constant(HAT_EF_astralstrike_B);
	export_constant(HAT_EF_froral_flareroad_A);
	export_constant(HAT_EF_froral_flareroad_B);
	export_constant(HAT_EF_crimsonarrow_A);
	export_constant(HAT_EF_crimsonarrow_B);
	export_constant(HAT_EF_rain_of_crystal_A);
	export_constant(HAT_EF_rain_of_crystal_B);
	export_constant(HAT_EF_crystal_impact_A);
	export_constant(HAT_EF_crystal_impact_B);
	export_constant(HAT_EF_crystal_impact_C);
	export_constant(HAT_EF_tornadostorm_A);
	export_constant(HAT_EF_tornadostorm_B);
	export_constant(HAT_EF_strantumtremor_A);
	export_constant(HAT_EF_strantumtremor_B);
	export_constant(HAT_EF_rockdown_A);
	export_constant(HAT_EF_rockdown_B);
	export_constant(HAT_EF_violentquake_A);
	export_constant(HAT_EF_violentquake_B);
	export_constant(HAT_EF_terradrive_A);
	export_constant(HAT_EF_terradrive_B);
	export_constant(HAT_EF_lightning_land_A);
	export_constant(HAT_EF_lightning_land_B);
	export_constant(HAT_EF_venom_swamp_A);
	export_constant(HAT_EF_venom_swamp_B);
	export_constant(HAT_EF_activity_burn_A);
	export_constant(HAT_EF_activity_burn_B);
	export_constant(HAT_EF_increasing_activity_A);
	export_constant(HAT_EF_increasing_activity_B);
	export_constant(HAT_EF_diluvio_A);
	export_constant(HAT_EF_diluvio_B);
	export_constant(HAT_EF_ardor_A);
	export_constant(HAT_EF_ardor_B);
	export_constant(HAT_EF_procella_A);
	export_constant(HAT_EF_procella_B);
	export_constant(HAT_EF_terremotus_A);
	export_constant(HAT_EF_terremotus_B);
	export_constant(HAT_EF_serpens_A);
	export_constant(HAT_EF_serpens_B);
	export_constant(HAT_EF_new_dilectioheal_A);
	export_constant(HAT_EF_new_dilectioheal_B);
	export_constant(HAT_EF_new_dilectioheal_C);
	export_constant(HAT_EF_new_dilectioheal_D);
	export_constant(HAT_EF_competentia_A);
	export_constant(HAT_EF_competentia_B);
	export_constant(HAT_EF_benedictum_A);
	export_constant(HAT_EF_benedictum_B);
	export_constant(HAT_EF_arbitrium_A);
	export_constant(HAT_EF_arbitrium_B);
	export_constant(HAT_EF_pneumaticusprocella);
	export_constant(HAT_EF_sincerefaith);
	export_constant(HAT_EF_new_a_machine_A);
	export_constant(HAT_EF_new_a_machine_B);
	export_constant(HAT_EF_new_d_machine_A);
	export_constant(HAT_EF_new_d_machine_B);
	export_constant(HAT_EF_new_d_machine_C);
	export_constant(HAT_EF_adv_protection_A);
	export_constant(HAT_EF_adv_protection_B);
	export_constant(HAT_EF_adv_protection_C);
	export_constant(HAT_EF_acidified_zone_fire_A);
	export_constant(HAT_EF_acidified_zone_fire_B);
	export_constant(HAT_EF_acidified_zone_ground_A);
	export_constant(HAT_EF_acidified_zone_ground_B);
	export_constant(HAT_EF_acidified_zone_water_A);
	export_constant(HAT_EF_acidified_zone_water_B);
	export_constant(HAT_EF_acidified_zone_wind_A);
	export_constant(HAT_EF_acidified_zone_wind_B);
	export_constant(HAT_EF_wooden_fairy_A);
	export_constant(HAT_EF_wooden_fairy_B);
	export_constant(HAT_EF_wooden_warrior_A);
	export_constant(HAT_EF_wooden_warrior_B);
	export_constant(HAT_EF_hawkvumerang_A);
	export_constant(HAT_EF_hawkvumerang_B);
	export_constant(HAT_EF_hawkvumerang_C);
	export_constant(HAT_EF_solidtrap_A);
	export_constant(HAT_EF_solidtrap_B);
	export_constant(HAT_EF_flametrap_A);
	export_constant(HAT_EF_flametrap_B);
	export_constant(HAT_EF_deepblindtrap_A);
	export_constant(HAT_EF_deepblindtrap_B);
	export_constant(HAT_EF_swifttrap_A);
	export_constant(HAT_EF_swifttrap_B);
	export_constant(HAT_EF_rhythmshooting_A);
	export_constant(HAT_EF_rhythmshooting_B);
	export_constant(HAT_EF_soundblend_A);
	export_constant(HAT_EF_soundblend_B);
	export_constant(HAT_EF_mysticsymphony);
	export_constant(HAT_EF_jawaii_serenade_A);
	export_constant(HAT_EF_jawaii_serenade_B);
	export_constant(HAT_EF_pronmarch_A);
	export_constant(HAT_EF_pronmarch_B);
	export_constant(HAT_EF_roki_capriccio_A);
	export_constant(HAT_EF_roki_capriccio_B);
	export_constant(HAT_EF_kvasirsonata_A);
	export_constant(HAT_EF_kvasirsonata_B);
	export_constant(HAT_EF_hidden_card);
	export_constant(HAT_EF_auto_firing_launcher);
	export_constant(HAT_EF_mega_sonic_blow);
	export_constant(HAT_EF_breakinglimit);
	export_constant(HAT_EF_new_comet_A);
	export_constant(HAT_EF_new_comet_B);
	export_constant(HAT_EF_new_strantumtremor_A);
	export_constant(HAT_EF_new_strantumtremor_B);
	export_constant(HAT_EF_new_varetyrspear_A);
	export_constant(HAT_EF_new_varetyrspear_B);
	export_constant(HAT_EF_new_wallofthorn_A);
	export_constant(HAT_EF_new_wallofthorn_B);
	export_constant(HAT_EF_new_judex_A);
	export_constant(HAT_EF_new_judex_B);
	export_constant(HAT_EF_new_judex_C);
	export_constant(HAT_EF_new_judex_D);
	export_constant(HAT_EF_new_judex_E);
	export_constant(HAT_EF_new_diamonddust);
	export_constant(HAT_EF_new_cart_cannon_A);
	export_constant(HAT_EF_new_cart_cannon_B);
	export_constant(HAT_EF_judgement_cross_A);
	export_constant(HAT_EF_judgement_cross_B);
	export_constant(HAT_EF_judgement_cross_C);
	export_constant(HAT_EF_judgement_cross_D);
	export_constant(HAT_EF_grand_judgement_A);
	export_constant(HAT_EF_grand_judgement_B);
	export_constant(HAT_EF_attack_stance_A);
	export_constant(HAT_EF_attack_stance_B);
	export_constant(HAT_EF_guard_stance_A);
	export_constant(HAT_EF_guard_stance_B);
	...
	export_constant(HAT_EF_abstract_flower_aura_A);
	export_constant(HAT_EF_abstract_flower_aura_B);
	export_constant(HAT_EF_aiyu_aura_A);
	export_constant(HAT_EF_aiyu_aura_B);
	export_constant(HAT_EF_amulet_aura_A);
	export_constant(HAT_EF_amulet_aura_B);
	export_constant(HAT_EF_angelic_aura_A);
	export_constant(HAT_EF_angelic_aura_B);
	export_constant(HAT_EF_aniexiles_aura_A);
	export_constant(HAT_EF_aniexiles_aura_B);
	export_constant(HAT_EF_crest_moon_aura_A);
	export_constant(HAT_EF_crest_moon_aura_B);
	export_constant(HAT_EF_solestic_aura_A);
	export_constant(HAT_EF_solestic_aura_B);
	export_constant(HAT_EF_arcane_red_aura_A);
	export_constant(HAT_EF_arcane_red_aura_B);
	export_constant(HAT_EF_arcane_blue_aura_A);
	export_constant(HAT_EF_arcane_blue_aura_B);
	export_constant(HAT_EF_arcane_pink_aura_A);
	export_constant(HAT_EF_arcane_pink_aura_B);
	export_constant(HAT_EF_arcane_green_aura_A);
	export_constant(HAT_EF_arcane_green_aura_B);
	export_constant(HAT_EF_artic_galaxy_aura_A);
	export_constant(HAT_EF_artic_galaxy_aura_B);
	export_constant(HAT_EF_king_of_aura_A);
	export_constant(HAT_EF_king_of_aura_B);
	export_constant(HAT_EF_flame_aura_A);
	export_constant(HAT_EF_flame_aura_B);
	export_constant(HAT_EF_autum_leaf_aura_A);
	export_constant(HAT_EF_autum_leaf_aura_B);
	export_constant(HAT_EF_dolphin_aura_A);
	export_constant(HAT_EF_dolphin_aura_B);
	export_constant(HAT_EF_voodoo_aura_A);
	export_constant(HAT_EF_voodoo_aura_B);
	export_constant(HAT_EF_blood_aura_A);
	export_constant(HAT_EF_blood_aura_B);
	export_constant(HAT_EF_bloody_sun_aura_A);
	export_constant(HAT_EF_bloody_sun_aura_B);
	export_constant(HAT_EF_blubble_aura_A);
	export_constant(HAT_EF_blubble_aura_B);
	export_constant(HAT_EF_blue_fume_aura_A);
	export_constant(HAT_EF_blue_fume_aura_B);
	export_constant(HAT_EF_blue_heaven_aura_A);
	export_constant(HAT_EF_blue_heaven_aura_B);
	export_constant(HAT_EF_blue_moon_aura_A);
	export_constant(HAT_EF_blue_moon_aura_B);
	export_constant(HAT_EF_blush_aura_A);
	export_constant(HAT_EF_blush_aura_B);
	export_constant(HAT_EF_bubble_2_aura_A);
	export_constant(HAT_EF_bubble_2_aura_B);
	export_constant(HAT_EF_butterfly_aura_A);
	export_constant(HAT_EF_butterfly_aura_B);
	export_constant(HAT_EF_effect_aura);
	...
	export_constant(HAT_EF_bautterfly_2_aura_A);
	export_constant(HAT_EF_bautterfly_2_aura_B);
	export_constant(HAT_EF_celestia_tattoo_aura_A);
	export_constant(HAT_EF_celestia_tattoo_aura_B);
	export_constant(HAT_EF_celtic_aura_A);
	export_constant(HAT_EF_celtic_aura_B);
	export_constant(HAT_EF_celtic_flower_aura_A);
	export_constant(HAT_EF_celtic_flower_aura_B);
	export_constant(HAT_EF_celtic_green_aura_A);
	export_constant(HAT_EF_celtic_green_aura_B);
	export_constant(HAT_EF_celtic_heart_aura_A);
	export_constant(HAT_EF_celtic_heart_aura_B);
	export_constant(HAT_EF_celtic_protection_aura_A);
	export_constant(HAT_EF_celtic_protection_aura_B);
	export_constant(HAT_EF_chococat_aura_A);
	export_constant(HAT_EF_chococat_aura_B);
	export_constant(HAT_EF_circle_of_power_aura_A);
	export_constant(HAT_EF_circle_of_power_aura_B);
	export_constant(HAT_EF_color_swirls_aura_A);
	export_constant(HAT_EF_color_swirls_aura_B);
	export_constant(HAT_EF_crest_aura_A);
	export_constant(HAT_EF_crest_aura_B);
	export_constant(HAT_EF_cross_aura_A);
	export_constant(HAT_EF_cross_aura_B);
	export_constant(HAT_EF_daisy_aura_A);
	export_constant(HAT_EF_daisy_aura_B);
	export_constant(HAT_EF_dark_summoning_aura_A);
	export_constant(HAT_EF_dark_summoning_aura_B);
	export_constant(HAT_EF_demon_symbol_aura_A);
	export_constant(HAT_EF_demon_symbol_aura_B);
	export_constant(HAT_EF_anime_aura_A);
	export_constant(HAT_EF_anime_aura_B);
	export_constant(HAT_EF_devotion_aura_A);
	export_constant(HAT_EF_devotion_aura_B);
	export_constant(HAT_EF_dolphin_2_aura_A);
	export_constant(HAT_EF_dolphin_2_aura_B);
	export_constant(HAT_EF_dragon_aura_A);
	export_constant(HAT_EF_dragon_aura_B);
	export_constant(HAT_EF_dragon_head_aura_A);
	export_constant(HAT_EF_dragon_head_aura_B);
	export_constant(HAT_EF_dragonflies_aura_A);
	export_constant(HAT_EF_dragonflies_aura_B);
	export_constant(HAT_EF_envy_aura_A);
	export_constant(HAT_EF_envy_aura_B);
	export_constant(HAT_EF_fairy_aura_A);
	export_constant(HAT_EF_fairy_aura_B);
	export_constant(HAT_EF_fire_sun_aura_A);
	export_constant(HAT_EF_fire_sun_aura_B);
	export_constant(HAT_EF_flamy_sun_2_aura_A);
	export_constant(HAT_EF_flamy_sun_2_aura_B);
	export_constant(HAT_EF_flamy_sun_aura_A);
	export_constant(HAT_EF_flamy_sun_aura_B);
	export_constant(HAT_EF_flashy_2_aura_A);
	export_constant(HAT_EF_flashy_2_aura_B);
	export_constant(HAT_EF_flashy_3_aura_A);
	export_constant(HAT_EF_flashy_3_aura_B);
	export_constant(HAT_EF_flashy_aura_A);
	export_constant(HAT_EF_flashy_aura_B);
	export_constant(HAT_EF_flower_aura_A);
	export_constant(HAT_EF_flower_aura_B);
	export_constant(HAT_EF_force_aura_A);
	export_constant(HAT_EF_force_aura_B);
	export_constant(HAT_EF_full_metal_alchemist_aura_A);
	export_constant(HAT_EF_full_metal_alchemist_aura_B);
	export_constant(HAT_EF_funky_colors_aura_A);
	export_constant(HAT_EF_funky_colors_aura_B);
	export_constant(HAT_EF_ghost_1_aura_A);
	export_constant(HAT_EF_ghost_1_aura_B);
	export_constant(HAT_EF_ghost_2_aura_A);
	export_constant(HAT_EF_ghost_2_aura_B);
	export_constant(HAT_EF_ghost_3_aura_A);
	export_constant(HAT_EF_ghost_3_aura_B);
	export_constant(HAT_EF_ghost_4_aura_A);
	export_constant(HAT_EF_ghost_4_aura_B);
	export_constant(HAT_EF_grape_aura_A);
	export_constant(HAT_EF_grape_aura_B);
	export_constant(HAT_EF_greed_aura_A);
	export_constant(HAT_EF_greed_aura_B);
	export_constant(HAT_EF_green_plant_aura_A);
	export_constant(HAT_EF_green_plant_aura_B);
	export_constant(HAT_EF_green_swirls_aura_A);
	export_constant(HAT_EF_green_swirls_aura_B);
	export_constant(HAT_EF_green_wing_aura_A);
	export_constant(HAT_EF_green_wing_aura_B);
	export_constant(HAT_EF_grunge_green_aura_A);
	export_constant(HAT_EF_grunge_green_aura_B);
	export_constant(HAT_EF_guiding_star_aura_A);
	export_constant(HAT_EF_guiding_star_aura_B);
	export_constant(HAT_EF_tornado_aura_A);
	export_constant(HAT_EF_tornado_aura_B);
	export_constant(HAT_EF_heart_aura_A);
	export_constant(HAT_EF_heart_aura_B);
	export_constant(HAT_EF_hello_kitty_aura_A);
	export_constant(HAT_EF_hello_kitty_aura_B);
	export_constant(HAT_EF_hellsing_aura_A);
	export_constant(HAT_EF_hellsing_aura_B);
	export_constant(HAT_EF_holy_1_aura_A);
	export_constant(HAT_EF_holy_1_aura_B);
	export_constant(HAT_EF_holy_aura_A);
	export_constant(HAT_EF_holy_aura_B);
	export_constant(HAT_EF_human_emblem_aura_A);
	export_constant(HAT_EF_human_emblem_aura_B);
	export_constant(HAT_EF_lady_bug_aura_A);
	export_constant(HAT_EF_lady_bug_aura_B);
	export_constant(HAT_EF_lauriers_aura_A);
	export_constant(HAT_EF_lauriers_aura_B);
	export_constant(HAT_EF_lead_circlet_aura_A);
	export_constant(HAT_EF_lead_circlet_aura_B);
	export_constant(HAT_EF_leal_life_aura_A);
	export_constant(HAT_EF_leal_life_aura_B);
	export_constant(HAT_EF_lifesource_aura_A);
	export_constant(HAT_EF_lifesource_aura_B);
	export_constant(HAT_EF_limitless_flowers_aura_A);
	export_constant(HAT_EF_limitless_flowers_aura_B);
	export_constant(HAT_EF_lionheart_aura_A);
	export_constant(HAT_EF_lionheart_aura_B);
	export_constant(HAT_EF_little_rounds_aura_A);
	export_constant(HAT_EF_little_rounds_aura_B);
	export_constant(HAT_EF_lord_of_the_rings_aura_A);
	export_constant(HAT_EF_lord_of_the_rings_aura_B);
	export_constant(HAT_EF_lotus_aura_A);
	export_constant(HAT_EF_lotus_aura_B);
	export_constant(HAT_EF_love_aura_A);
	export_constant(HAT_EF_love_aura_B);
	export_constant(HAT_EF_lust_aura_A);
	export_constant(HAT_EF_lust_aura_B);
	export_constant(HAT_EF_magic_circle_aura_A);
	export_constant(HAT_EF_magic_circle_aura_B);
	export_constant(HAT_EF_manic_aura_A);
	export_constant(HAT_EF_manic_aura_B);
	export_constant(HAT_EF_medieval_heart_aura_A);
	export_constant(HAT_EF_medieval_heart_aura_B);
	export_constant(HAT_EF_merlin_aura_A);
	export_constant(HAT_EF_merlin_aura_B);
	export_constant(HAT_EF_metallic_butterfly_aura_A);
	export_constant(HAT_EF_metallic_butterfly_aura_B);
	export_constant(HAT_EF_midnight_fenrir_aura_A);
	export_constant(HAT_EF_midnight_fenrir_aura_B);
	export_constant(HAT_EF_mist_of_azure_aura_A);
	export_constant(HAT_EF_mist_of_azure_aura_B);
	export_constant(HAT_EF_musical_aura_A);
	export_constant(HAT_EF_musical_aura_B);
	export_constant(HAT_EF_nature_aura_A);
	export_constant(HAT_EF_nature_aura_B);
	export_constant(HAT_EF_necromancy_aura_A);
	export_constant(HAT_EF_necromancy_aura_B);
	export_constant(HAT_EF_phoenix_aura_A);
	export_constant(HAT_EF_phoenix_aura_B);
	export_constant(HAT_EF_pretty_lotus_aura_A);
	export_constant(HAT_EF_pretty_lotus_aura_B);
	export_constant(HAT_EF_pride_aura_A);
	export_constant(HAT_EF_pride_aura_B);
	export_constant(HAT_EF_pumpkin_aura_A);
	export_constant(HAT_EF_pumpkin_aura_B);
	export_constant(HAT_EF_purple_flower_aura_A);
	export_constant(HAT_EF_purple_flower_aura_B);
	export_constant(HAT_EF_chain_lock_aura_A);
	export_constant(HAT_EF_chain_lock_aura_B);
	export_constant(HAT_EF_cross_holy_aura_A);
	export_constant(HAT_EF_cross_holy_aura_B);
	export_constant(HAT_EF_purple_moon_aura_A);
	export_constant(HAT_EF_purple_moon_aura_B);
	export_constant(HAT_EF_purple_pace_aura_A);
	export_constant(HAT_EF_purple_pace_aura_B);
	export_constant(HAT_EF_red_cross_aura_A);
	export_constant(HAT_EF_red_cross_aura_B);
	export_constant(HAT_EF_red_shield_aura_A);
	export_constant(HAT_EF_red_shield_aura_B);
	export_constant(HAT_EF_red_smoke_aura_A);
	export_constant(HAT_EF_red_smoke_aura_B);
	export_constant(HAT_EF_red_splash_aura_A);
	export_constant(HAT_EF_red_splash_aura_B);
	export_constant(HAT_EF_red_stars_aura_A);
	export_constant(HAT_EF_red_stars_aura_B);
	export_constant(HAT_EF_red_wave_aura_A);
	export_constant(HAT_EF_red_wave_aura_B);
	export_constant(HAT_EF_rose_2_aura_A);
	export_constant(HAT_EF_rose_2_aura_B);
	export_constant(HAT_EF_rose_aura_A);
	export_constant(HAT_EF_rose_aura_B);
	export_constant(HAT_EF_rose_necklace_aura_A);
	export_constant(HAT_EF_rose_necklace_aura_B);
	export_constant(HAT_EF_scribble_aura_A);
	export_constant(HAT_EF_scribble_aura_B);
	export_constant(HAT_EF_server_current_aura_A);
	export_constant(HAT_EF_server_current_aura_B);
	export_constant(HAT_EF_shadow_aura_A);
	export_constant(HAT_EF_shadow_aura_B);
	export_constant(HAT_EF_skull_aura_A);
	export_constant(HAT_EF_skull_aura_B);
	export_constant(HAT_EF_sloth_aura_A);
	export_constant(HAT_EF_sloth_aura_B);
	export_constant(HAT_EF_snow_aura_A);
	export_constant(HAT_EF_snow_aura_B);
	export_constant(HAT_EF_solar_2_aura_A);
	export_constant(HAT_EF_solar_2_aura_B);
	export_constant(HAT_EF_solar_3_aura_A);
	export_constant(HAT_EF_solar_3_aura_B);
	export_constant(HAT_EF_solar_aura_A);
	export_constant(HAT_EF_solar_aura_B);
	export_constant(HAT_EF_something_aura_A);
	export_constant(HAT_EF_something_aura_B);
	export_constant(HAT_EF_spike_aura_A);
	export_constant(HAT_EF_spike_aura_B);
	export_constant(HAT_EF_splash_circle_aura_A);
	export_constant(HAT_EF_splash_circle_aura_B);
	export_constant(HAT_EF_square_aura_A);
	export_constant(HAT_EF_square_aura_B);
	export_constant(HAT_EF_star_aura_A);
	export_constant(HAT_EF_star_aura_B);
	export_constant(HAT_EF_strawberry_aura_A);
	export_constant(HAT_EF_strawberry_aura_B);
	export_constant(HAT_EF_sun_and_moon_aura_A);
	export_constant(HAT_EF_sun_and_moon_aura_B);
	export_constant(HAT_EF_triangle_aura_A);
	export_constant(HAT_EF_triangle_aura_B);
	export_constant(HAT_EF_tribal_aura_A);
	export_constant(HAT_EF_tribal_aura_B);
	export_constant(HAT_EF_tricky_sun_aura_A);
	export_constant(HAT_EF_tricky_sun_aura_B);
	export_constant(HAT_EF_trigger_symbol_aura_A);
	export_constant(HAT_EF_trigger_symbol_aura_B);
	export_constant(HAT_EF_batman_aura_A);
	export_constant(HAT_EF_batman_aura_B);
	export_constant(HAT_EF_turquoise_aura_A);
	export_constant(HAT_EF_turquoise_aura_B);
	export_constant(HAT_EF_undead_green_sigil_aura_A);
	export_constant(HAT_EF_undead_green_sigil_aura_B);
	export_constant(HAT_EF_undead_red_sigil_aura_A);
	export_constant(HAT_EF_undead_red_sigil_aura_B);
	export_constant(HAT_EF_undead_sigil_aura_A);
	export_constant(HAT_EF_undead_sigil_aura_B);
	export_constant(HAT_EF_unholy_aura_A);
	export_constant(HAT_EF_unholy_aura_B);
	export_constant(HAT_EF_unicorn_aura_A);
	export_constant(HAT_EF_unicorn_aura_B);
	export_constant(HAT_EF_unknown_aura_A);
	export_constant(HAT_EF_unknown_aura_B);
	export_constant(HAT_EF_unwanted_happening_aura_A);
	export_constant(HAT_EF_unwanted_happening_aura_B);
	export_constant(HAT_EF_wavy_circle_aura_A);
	export_constant(HAT_EF_wavy_circle_aura_B);
	export_constant(HAT_EF_wedding_aura_A);
	export_constant(HAT_EF_wedding_aura_B);
	export_constant(HAT_EF_white_swirl_aura_A);
	export_constant(HAT_EF_white_swirl_aura_B);
	export_constant(HAT_EF_wrath_aura_A);
	export_constant(HAT_EF_wrath_aura_B);
	export_constant(HAT_EF_yellow_smoke_aura_A);
	export_constant(HAT_EF_yellow_smoke_aura_B);
	export_constant(HAT_EF_zeet_blue_aura_A);
	export_constant(HAT_EF_zeet_blue_aura_B);
	export_constant(HAT_EF_zeet_pink_aura_A);
	export_constant(HAT_EF_zeet_pink_aura_B);
	export_constant(HAT_EF_zeet_red_aura_A);
	export_constant(HAT_EF_zeet_red_aura_B);
	export_constant(HAT_EF_absolute_zephyr);
	export_constant(HAT_EF_allbloom_A);
	export_constant(HAT_EF_allbloom_B);
	export_constant(HAT_EF_chain_reaction_shot_A);
	export_constant(HAT_EF_chain_reaction_shot_B);
	export_constant(HAT_EF_crossrain_A);
	export_constant(HAT_EF_crossrain_B);
	export_constant(HAT_EF_dancing_knife_A);
	export_constant(HAT_EF_dancing_knife_B);
	export_constant(HAT_EF_destructive_hurricane_A);
	export_constant(HAT_EF_destructive_hurricane_B);
	export_constant(HAT_EF_firmfaith);
	export_constant(HAT_EF_frozen_slash_A);
	export_constant(HAT_EF_frozen_slash_B);
	export_constant(HAT_EF_gef_nocturn_A);
	export_constant(HAT_EF_gef_nocturn_B);
	export_constant(HAT_EF_new_aimedbolt);
	export_constant(HAT_EF_new_aromaoil_A);
	export_constant(HAT_EF_new_aromaoil_B);
	export_constant(HAT_EF_new_axeboomerang_A);
	export_constant(HAT_EF_new_axeboomerang_B);
	export_constant(HAT_EF_new_chainlightning);
	export_constant(HAT_EF_new_fatal_menace_A);
	export_constant(HAT_EF_new_fatal_menace_B);
	export_constant(HAT_EF_new_hellInferno);
	export_constant(HAT_EF_new_howlingoflion_A);
	export_constant(HAT_EF_new_howlingoflion_B);
	export_constant(HAT_EF_new_overbrand_A);
	export_constant(HAT_EF_new_overbrand_B);
	export_constant(HAT_EF_new_pramen);
	export_constant(HAT_EF_new_soulexpansion_A);
	export_constant(HAT_EF_new_soulexpansion_B);
	export_constant(HAT_EF_new_soulexpansion_C);
	export_constant(HAT_EF_new_soundofdestruction_A);
	export_constant(HAT_EF_new_soundofdestruction_B);
	export_constant(HAT_EF_new_spellfist_A);
	export_constant(HAT_EF_new_spellfist_B);
	export_constant(HAT_EF_new_spellfist_C);
	export_constant(HAT_EF_new_tornadostorm_A);
	export_constant(HAT_EF_new_tornadostorm_B);
	export_constant(HAT_EF_powerfulfaith);
	export_constant(HAT_EF_rebound_shield_A);
	export_constant(HAT_EF_rebound_shield_B);
	export_constant(HAT_EF_roseblossom_A);
	export_constant(HAT_EF_roseblossom_B);
	export_constant(HAT_EF_roseblossom_C);
	...
	export_constant(HAT_EF_firstfaithpower_A);
	export_constant(HAT_EF_firstfaithpower_B);
	export_constant(HAT_EF_firstfaithpower_C);
	export_constant(HAT_EF_helltree_A);
	export_constant(HAT_EF_helltree_B);
	export_constant(HAT_EF_abyss_slayer_A);
	export_constant(HAT_EF_abyss_slayer_B);
	export_constant(HAT_EF_abyss_slayer_C);
	export_constant(HAT_EF_judge_A);
	export_constant(HAT_EF_judge_B);
	export_constant(HAT_EF_judge_C);
	export_constant(HAT_EF_judge_D);
	export_constant(HAT_EF_thirdexorflame_A);
	export_constant(HAT_EF_thirdexorflame_B);
	export_constant(HAT_EF_thirdexorflame_C);
	export_constant(HAT_EF_thirdexorflame_D);
	export_constant(HAT_EF_ske_rising_sun_A);
	export_constant(HAT_EF_ske_rising_sun_B);
	export_constant(HAT_EF_ske_rising_sun_C);
	export_constant(HAT_EF_ske_rising_moon_A);
	export_constant(HAT_EF_ske_rising_moon_B);
	export_constant(HAT_EF_ske_rising_moon_C);
	export_constant(HAT_EF_ske_enchanting_sky);
	export_constant(HAT_EF_circle_directions_elements);
	export_constant(HAT_EF_talisman_of_magician);
	export_constant(HAT_EF_soul_of_heaven_and_earth);
	export_constant(HAT_EF_servant_sign_A);
	export_constant(HAT_EF_servant_sign_B);
	export_constant(HAT_EF_vigor);
	export_constant(HAT_EF_dragonic_aura_A);
	export_constant(HAT_EF_dragonic_aura_B);
	export_constant(HAT_EF_diamond_storm_A);
	export_constant(HAT_EF_diamond_storm_B);
	export_constant(HAT_EF_conflagration_A);
	export_constant(HAT_EF_conflagration_B);
	export_constant(HAT_EF_enchanting_shadow_A);
