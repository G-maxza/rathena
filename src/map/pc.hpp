...
struct map_session_data {
	...
	struct s_state {
		...
		bool refineui_open;
		unsigned short message_vip; // VIP System
		unsigned int afk;
	...
	int connection_reward_timer;
	int connection_reward_tick;
	int connection_reward_pts;
	struct script_code* connection_script;
