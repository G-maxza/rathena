...
// 2015-05-13aRagexe
	...
	// Connection reward - Shakto - https://ronovelty.com/
	packet( HEADER_ZC_CONNECTION_REWARD, sizeof(PACKET_ZC_CONNECTION_REWARD) );
	parseable_packet( HEADER_CZ_CONNECTION_REWARD, sizeof( PACKET_CZ_CONNECTION_REWARD ), clif_parse_connection_reward, 0 );
#endif
