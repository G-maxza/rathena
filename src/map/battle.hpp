...
// eAthena additions
	...
	// Chat Clone
	int chat_clone_system;
	int chat_can_anywhere;
	...
	int feature_connection_reward;
	int feature_connection_reward_timer;
	int feature_connection_reward_pts;
	int feature_connection_reward_max;
	int feature_connection_reward_vip;
